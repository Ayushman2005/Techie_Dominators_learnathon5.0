...
<svelte:head><title>Hostel Notice Board · Warden Panel</title></svelte:head>

<PageHeader title="Hostel Notice Board" description="Broadcast important updates to your assigned hostel." />
	...
	<div class="md:col-span-1">
		<Card>
			<CardHeader>
				...
				<CardDescription>Publish a notice visible to everyone in your hostel.</CardDescription>
			</CardHeader>
			<CardContent>
				<form onsubmit={handleCreate} class="space-y-4">
					...
					<Button type="submit" class="w-full" disabled={formSubmitting}>
						{formSubmitting ? 'Publishing...' : 'Publish Notice'}
					</Button>
				</form>
			</CardContent>
		</Card>
